      ...
      body: Obx(() {
        ...
        return ListView(
          ...
          children: [
            ...
            // AI-план питания
            const SectionHeader(title: 'AI-ПЛАН ПИТАНИЯ', padding: EdgeInsets.zero),
            const SizedBox(height: 8),
...
class _AiPlanSectionState extends State<_AiPlanSection> {
  ...
  void initState() {
    ...
    final c = widget.controller;
    _heightCtr =
        TextEditingController(text: c.heightCm.toStringAsFixed(0));
    _ageCtr = TextEditingController(text: c.age.toString());
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(() => Row(
                children: [
                  _GenderChip(
                    ...
                    onTap: () async {
                      await Get.find<SettingsService>().setGender('male');
                      c.update();
                    },
                  ),
                  const SizedBox(width: 10),
                  _GenderChip(
                    ...
                    onTap: () async {
                      await Get.find<SettingsService>().setGender('female');
                      c.update();
                    },
                  ),
                ],
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      onChanged: (v) {
                        ...
                        if (val != null && val > 0) {
                          Get.find<SettingsService>().setHeightCm(val);
                        }
                      },
                    ),
                  ],
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      onChanged: (v) {
                        ...
                        if (val != null && val > 0) {
                          Get.find<SettingsService>().setAge(val);
                        }
                      },
                    ),
                  ],
          ...
          Obx(() {
            ...
            final tdee = c.tdee;
            final target = c.targetCaloriesAdjusted;
            return Container(
