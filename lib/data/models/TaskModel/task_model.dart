...
class TaskModel extends HiveObject {
  ...
  /// Используется только если foodItemIds содержит один продукт (обратная совместимость).
  @HiveField(15)
  double foodGrams;

  // ignore: unintended_html_in_doc_comment
  /// Граммы потребления для каждого продукта: <foodItemId, grams>
  /// Актуальное поле при наличии нескольких продуктов в задаче.
  @HiveField(16)
